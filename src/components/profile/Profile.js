                            ...
                            <div className="profile__User">
                                <div className="profile__UserInfo">
                                    ...
                                    <div className="profile_statsMain">
                                        <ul>
                                            <li><p>Views</p><span>{userInformation.totalViews}</span></li>
                                            <li><p>Likes</p><span>{userInformation.totalLikes}</span></li>
                                            <li><p>Followers</p><span>{userInformation.followers}</span></li>
                                            <li><p>Following</p><span>{userInformation.following}</span></li>
                                        </ul>
                                    </div>
